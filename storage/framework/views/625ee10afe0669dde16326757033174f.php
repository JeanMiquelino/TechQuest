...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>">
        ...
        <div class="checkbox<?php echo e($errors->has('terms') ? ' has-error' : ''); ?>">
            <label for="terms">
                <input name="terms" type="checkbox" <?php if(old('terms')): echo 'checked'; endif; ?>> Eu concordo com os <a href="#">termos</a>
            </label>
...
<?php echo $__env->make('layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Jean\Desktop\TechQuest\resources\views/auth/register.blade.php ENDPATH**/ ?>