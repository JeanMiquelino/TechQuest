...
return [
    ...
    */
    ...
    'alpha_dash' => 'O :attribute pode conter apenas letras, números, hífens e sublinhados.',
    ...
    | usando a convenção "attribute.rule" para nomear as linhas. Isso torna mais rápido
    ...
    */
    ...
    'attributes' => [
        'choices.*.text' => 'texto da opção de resposta',
        'choices.*.score' => 'pontuação da opção de resposta',
